# CarbonNexus Privacy Policy

1. Introduction

    This Privacy Policy describes how CarbonNexus ("CarbonNexus," "We," "Our," "Us") collects, stores, and processes personal data in compliance with applicable data protection laws. CarbonNexus provides climate intelligence services, data analytics, and environmental monitoring solutions (collectively, the "Services") available through our website, social media channels, and email communications. This policy applies to all personal data collected through our website at https://carbonnexus.io and any other channels used to access our Services.

2. Data Controller and Data Protection Officer (DPO)

    CarbonNexus is the data controller for the processing of your personal data. For any queries, you may contact us at contact@carbonnexus.io.
...
3. Personal Data We Collect
    ...
    3.3 Customers
        ...
        When making payments via CarbonNexus, the following personal data may be collected:

        - Email address  
        - IP address  
        - Donor’s name, email, address, phone number, employer, job title, and city of employment (for donations where required by law)

        Sensitive Data: CarbonNexus does not process sensitive personal data (e.g., religious or political views).

4. Legal Basis for Data Processing

    We process personal data based on the following legal grounds:

    - Contract Performance: To provide and manage CarbonNexus services (e.g., processing virtual assets payments, delivering notices).  
...
6. Data Subject Rights
    ...
    To exercise any of these rights, please contact our DPO at support@carbonnexus.io. We will respond within 30 days, subject to applicable legal exceptions.
...
11. Marketing
    ...
    We will only send you marketing communications with your explicit consent. You can opt out at any time by using the "unsubscribe" link in our emails or by contacting us at support@carbonnexus.io. We do not sell your personal data to third parties for their marketing purposes.
...
12. Cookies
    ...
    **What type of cookies do we use?**
    ...
    You may encounter cookies from third parties when using the CarbonNexus Services on websites that we do not control (for example, if you view a web page created by a third party or use an application developed by a third party, there may be a cookie placed by that web page or application.)

    **Managing your cookie settings**

    You can manage cookies through the settings of your Internet browser. You can have the browser notify you when you receive a new cookie, delete individual cookies or delete all cookies. Please note that, if you choose to delete CarbonNexus cookies, your access to some functionalities and areas of our website may be degraded or restricted.
