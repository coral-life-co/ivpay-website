...
export const socialsList = [
    ...
    { name: 'X' as const, icon: XIcon, link: "https://x.com/carbonnexus_io" },
    { name: 'Telegram' as const, icon: TelegramIcon, link: "https://t.me/carbonnexus_io" },
    { name: 'Medium' as const, icon: MediumIcon, link: "https://medium.com/@ivendpay" },
    { name: 'LinkedIn' as const, icon: LinkedInIcon, link: "https://www.linkedin.com/company/carbonnexus/" },
    { name: 'Instagram' as const, icon: InstagramIcon, link: "https://www.instagram.com/carbonnexus_io/" },
] as const;
